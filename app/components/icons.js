export function Icon({ name, size = 20, className = "", ...props }) {
  const paths = {
    bowl: (
      <>
        <path d="M3 12h18c-.6 5-3.8 8-9 8s-8.4-3-9-8Z" />
        <path d="M8 8c-2-2 2-3 0-5m5 5c-2-2 2-3 0-5m5 5c-2-2 2-3 0-5M8 21h8" />
      </>
    ),
    pantry: (
      <>
        <rect x="4" y="5" width="16" height="16" rx="3" />
        <path d="M7 2h10v3M4 11h16m-10 4h4" />
      </>
    ),
    basket: (
      <>
        <path d="m8 3-5 7m13-7 5 7M2 10h20l-2 10H4L2 10Zm7 4v3m6-3v3" />
      </>
    ),
    leaf: (
      <>
        <path d="M20 3C9 1 3 6 4 13c1 7 13 9 16-10Z" />
        <path d="M3 21 15 9" />
      </>
    ),
    arrow: (
    ...
    people: (
      <>
        ...
        <path d="M3 21v-3a6 6 0 0 1 12 0v3M16 5a3 3 0 0 1 0 6m2 4c3 0 4 3 4 6" />
      </>
    ),
    sliders: (
      <>
    ...
    jar: (
      <>
        <path d="M8 3h8v4H8zM7 7h10l2 4v8a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-8l2-4Z" />
        <path d="M5 13h14m-14 4h14" />
      </>
    ),
    phone: (
      <>
    ...
    history: (
      <>
        <path d="M3 3v5h5" />
        <path d="M3 8a9 9 0 1 1-1 7m10-8v5l4 2" />
      </>
    ),
  };
  return (
