...
const assets = [
  ['paneer.jpg', 'https://www.cookwithmanali.com/wp-content/uploads/2019/05/Paneer-Butter-Masala.jpg'],
  ['palak.jpg', 'https://www.maggi.in/sites/default/files/srh_recipes/f77b8de2a747b2c480726ef1dd65d53e.jpg'],
  ['chole.jpg', 'https://cdn.apartmenttherapy.info/image/upload/f_jpg,q_auto:eco,c_fill,g_auto,w_900,ar_16:9/k%2FPhoto%2FRecipe%20Ramp%20Up%2F2022-03-Chole%2Fchole-2'],
];
...
for (const [family, name] of [['DM+Sans:wght@400;500;600;700', 'dm-sans'], ['Lora:wght@400;500;600', 'lora']]) {
  jobs.push((async () => {
